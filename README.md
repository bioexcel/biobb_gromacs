...
[![](https://img.shields.io/badge/Singularity-GalaxyProject-blue)](https://depot.galaxyproject.org/singularity/biobb_gromacs:5.3.1--pyhdfd78af_0)
...
* Installation:
        ...
        pip install "biobb_gromacs>=5.3.1"
...
* Installation:
        ...
        conda install -c bioconda "biobb_gromacs>=5.3.1"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_gromacs:5.3.1--pyhdfd78af_0


* Usage:


        docker run quay.io/biocontainers/biobb_gromacs:5.3.1--pyhdfd78af_0 <command>
...
* Installation:
        ...
        singularity pull --name biobb_gromacs.sif https://depot.galaxyproject.org/singularity/biobb_gromacs:5.3.1--pyhdfd78af_0
